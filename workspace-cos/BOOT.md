# BOOT.md — Hannah Startup Manifest
...
Purpose: every open commitment Greg has made — check deadlines against today's date
Rules:
...
## Startup Complete
Hannah is ready. Do not proceed until all 8 steps are complete.
